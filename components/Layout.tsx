...
import { Users, User as UserIcon, Menu, LayoutDashboard } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#f2f2f7] flex items-center justify-center p-0 sm:p-8 font-['Inter',-apple-system,BlinkMacSystemFont,'Segoe_UI',Roboto,Helvetica,Arial,sans-serif]">
      ...
      <div className="relative w-full max-w-[430px] h-[92vh] sm:h-[844px] bg-white overflow-hidden shadow-[0_32px_64px_-12px_rgba(0,0,0,0.14)] sm:rounded-[54px] border border-slate-200/50 flex flex-col">
        ...
        <nav className="bg-white/90 backdrop-blur-xl border-t border-slate-100 flex justify-around items-center pt-2 pb-8 px-4 z-40">
          <button 
          ...
          >
            <Users size={24} strokeWidth={activeView === View.GROUPS ? 2.5 : 2} />
          ...
          >
            <UserIcon size={24} strokeWidth={activeView === View.FRIENDS ? 2.5 : 2} />
          ...
          >
            <LayoutDashboard size={24} strokeWidth={activeView === View.DASHBOARD ? 2.5 : 2} />
          ...
          >
            <Menu size={24} strokeWidth={activeView === View.ACCOUNT ? 2.5 : 2} />
